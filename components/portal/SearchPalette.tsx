  ...
  return (
    <>
      ...
      <button
        ...
        className="group flex h-9 w-[280px] items-center gap-2.5 rounded-xl border border-slate-200 bg-slate-50 px-4 text-[13px] text-slate-400 transition-all hover:border-slate-300 hover:bg-white"
      ...
      >
        ...
        <kbd className="ml-auto hidden items-center rounded border border-slate-200 bg-white px-1.5 py-0.5 font-mono text-[10px] text-slate-400 sm:flex">
          {kbd}
        </kbd>
      </button>
