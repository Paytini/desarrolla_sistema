...
const ACCENT_MAP: Record<string, string> = {
  "var(--brand)":            "#D96920",
  "var(--sidebar-accent-2)": "#0D9488",
  "var(--sidebar-accent-3)": "#6D28C4",
}
    ...
    <Link href={item.href} prefetch style={{ textDecoration: "none", color: "inherit", display: "block" }}>
      <ListItemButton
        ...
        sx={{
          ...
          "&.Mui-selected": {
            background: `linear-gradient(270deg, ${accent}, color-mix(in srgb, ${accent} 50%, white))`,
            color: "#fff",
            "& .sb-icon": { color: "#fff" },
            "&:hover": { background: `linear-gradient(270deg, ${accent}, color-mix(in srgb, ${accent} 50%, white))` },
          },
          "&:hover:not(.Mui-selected)": {
            bgcolor: "var(--mui-palette-action-hover)",
            color: "var(--mui-palette-text-primary)",
            "& .sb-icon": { color: "var(--mui-palette-text-primary)" },
          },
        }}
      >
        <ListItemIcon
