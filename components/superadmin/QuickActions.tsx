...
const ACTIONS: { label: string; description: string; href: string; Icon: LucideIcon }[] = [
  {
    label: "Empresas",
    description: "Clientes y cupos",
    href: "/superadmin/companies",
    Icon: Building2,
  },
  {
    label: "Paquetes",
    description: "Planes y cursos",
    href: "/superadmin/packages",
    Icon: Package,
  },
  {
    label: "Reportes",
    description: "Analíticas globales",
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 1 }}>
        {ACTIONS.map(({ label, description, href, Icon }) => (
          ...
          >
            ...
            <Box>
              <Typography
                sx={{ fontSize: 12, fontWeight: 600, lineHeight: 1.3, color: "text.primary" }}
              >
                {label}
              </Typography>
