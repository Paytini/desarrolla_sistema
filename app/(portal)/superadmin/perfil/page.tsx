      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_1.4fr]">
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-7">
          <div className="flex flex-col items-center gap-5">
            {/* Avatar */}
            <div className="flex size-24 items-center justify-center rounded-full bg-teal-600 text-3xl font-semibold text-white shadow-md">
              {initials}
            </div>
            ...
            <div className="w-full space-y-4">
              <div className="space-y-1 text-center">
                ...
                <span className="inline-flex rounded-full bg-teal-50 px-3 py-1 text-xs font-semibold text-teal-800 ring-1 ring-teal-200">
                  SuperAdmin
                </span>
              </div>
          ...
          <form action={changePasswordAction} className="grid gap-5">
            <label className="grid gap-1.5 text-sm">
              ...
              <input
                ...
                className="rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-teal-600 focus:ring-2 focus:ring-teal-100"
              />
            </label>
            ...
            <button
              type="submit"
              className="mt-1 inline-flex w-fit items-center gap-2 rounded-full bg-teal-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-teal-800"
            >
