...
> = {
  ...
  EMPLOYEE: [
    ...
    },
    {
      ...
      answer:
        "Una vez que termines un curso, tu constancia aparecerá en Mis constancias para descargarla.",
    },
    {
...
export default async function SupportPage() {
  ...
  return (
    <div className="max-w-7xl space-y-6">
      <PageHeader
        title="Soporte"
        description="Estamos para ayudarte con cualquier duda del portal."
      />
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-lg border border-portal-border bg-white p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-portal-ink">Preguntas frecuentes</h2>
            </div>

            <div className="divide-y divide-portal-border">
              {faqs.map((faq) => (
                <details key={faq.question} className="group py-3 first:pt-0 last:pb-0">
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-sm font-medium text-portal-ink outline-none focus-visible:ring-2 focus-visible:ring-portal-blue">
                    {faq.question}
        ...
        <div className="space-y-6">
          <aside className="h-fit rounded-lg border border-portal-border bg-white p-5">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-portal-ink">Horario de atención</h2>
            </div>
            <dl className="space-y-3 text-sm">
              <div>
                <dt className="text-slate-500">Días</dt>
                <dd className="font-medium text-portal-ink">Lunes a viernes</dd>
              </div>
              <div>
                <dt className="text-slate-500">Horario</dt>
                <dd className="font-medium text-portal-ink">7:00 a.m. – 4:00 p.m.</dd>
              </div>
              <div>
                <dt className="text-slate-500">Tiempo de respuesta</dt>
                <dd className="font-medium text-portal-ink">Menos de 24 horas hábiles</dd>
              </div>
            </dl>
          </aside>
