...
const POS = {
  ...
  fechas: {
    y: 362,
    step: 15,
    inicioAnioX: 255,  // primer dígito del año de inicio (4 cajas)
    ...
    finMesX:     495,  // primer dígito del mes de fin (2 cajas)
    finDiaX:     540,  // primer dígito del día de fin (2 cajas)
  },
  ...
  instructorNombre: { x: 75,  y: 168, size: 9 },
  // CONTROL INTERNO
